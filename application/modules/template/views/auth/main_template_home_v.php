  ...
  <div class="row">
    ...
    <div class="span6">
      <div class="aligncenter">
        <img src="<?php echo base_url('assets/basic/'); ?>img/icons/creativity.png" alt="" />
      </div>
    </div>
  </div>
  <div class="row">
    <div class="span2 offset1 flyIn">
      <div class="people">
        <img class="team-thumb img-circle" src="<?php echo base_url('assets/basic/'); ?>img/team/img-1.jpg" alt="" />
        <h3>John Doe</h3>
        <p>
          Art director
        </p>
    ...
    <div class="span2 flyIn">
      <div class="people">
        <img class="team-thumb img-circle" src="<?php echo base_url('assets/basic/'); ?>img/team/img-2.jpg" alt="" />
        <h3>Mike Doe</h3>
        <p>
          Web developer
        </p>
    ...
    <div class="span2 flyIn">
      <div class="people">
        <img class="team-thumb img-circle" src="<?php echo base_url('assets/basic/'); ?>img/team/img-3.jpg" alt="" />
        <h3>Neil Doe</h3>
        <p>
          Web designer
        </p>
    ...
    <div class="span2 flyIn">
      <div class="people">
        <img class="team-thumb img-circle" src="<?php echo base_url('assets/basic/'); ?>img/team/img-4.jpg" alt="" />
        <h3>Mark Joe</h3>
        <p>
          UI designer
        </p>
    ...
    <div class="span2 flyIn">
      <div class="people">
        <img class="team-thumb img-circle" src="<?php echo base_url('assets/basic/'); ?>img/team/img-5.jpg" alt="" />
        <h3>Stephen B</h3>
        <p>
          Digital imaging
        </p>
  ...
  <div class="row">
    <div class="span3 animated-fast flyIn">
      <div class="service-box">
        <img src="<?php echo base_url('assets/basic/'); ?>img/icons/laptop.png" alt="" />
        <h2>Web design</h2>
        <p>
    ...
    <div class="span3 animated flyIn">
      <div class="service-box">
        <img src="<?php echo base_url('assets/basic/'); ?>img/icons/lab.png" alt="" />
    ...
    <div class="span3 animated-fast flyIn">
      <div class="service-box">
        <img src="<?php echo base_url('assets/basic/'); ?>img/icons/camera.png" alt="" />
        <h2>Photography</h2>
        <p>
           Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        </p>
    ...
    <div class="span3 animated-slow flyIn">
      <div class="service-box">
        <img src="<?php echo base_url('assets/basic/'); ?>img/icons/basket.png" alt="" />
        <h2>Ecommerce</h2>
        <p>
           Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        </p>
    ...
    <div class="span12">
      <div id="portfolio-wrap">
        ...
        <div class="portfolio-item grid print photography">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/1.png" alt="" />
        ...
        <div class="portfolio-item grid print design web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/2.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid print design">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/3.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/4.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/5.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/6.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/7.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/8.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid photography web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/9.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
        ...
        <div class="portfolio-item grid design web">
          <div class="portfolio">
            <a href="<?php echo base_url('assets/basic/'); ?>img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
            <img src="<?php echo base_url('assets/basic/'); ?>img/works/10.png" alt="" />
            <div class="portfolio-overlay">
              <div class="thumb-info">
                <h5>Portfolio name</h5>
                <i class="icon-plus icon-2x"></i>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="span3">
      <div class="home-post">
        <div class="post-image">
          <img class="max-img" src="<?php echo base_url('assets/basic/'); ?>img/blog/img2.jpg" alt="" />
        </div>
        <div class="post-meta">
          <i class="icon-file icon-2x"></i>
          <span class="date">June 19, 2013</span>
    ...
    <div class="span3">
      <div class="home-post">
        <div class="post-image">
          <img class="max-img" src="<?php echo base_url('assets/basic/'); ?>img/blog/img3.jpg" alt="" />
        </div>
        <div class="post-meta">
          <i class="icon-file icon-2x"></i>
    ...
    <div class="span3">
      <div class="home-post">
        <div class="post-image">
          <img class="max-img" src="<?php echo base_url('assets/basic/'); ?>img/blog/img4.jpg" alt="" />
        </div>
        <div class="post-meta">
          <i class="icon-file icon-2x"></i>
