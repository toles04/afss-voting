    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>A</b>FSS</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Alumni</b>AFSS</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- <li><a href="#"><i class="fa fa-link"></i> <span>Votes</span></a></li> -->
      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          <b>AFSS</b> Alumni Admin.
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Company</a>.</strong> 
      </footer>
